...
description: "Analyzes GitHub Actions workflow run logs to generate test result reports, failed cases table, and skipped cases table. Invoke when user asks to analyze workflow logs, generate test reports, or summarize test results from downloaded logs."
---
...
从文件名提取流水线名，匹配模式：`(nightly|full)-(\d+)`
